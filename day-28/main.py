...
timer_title.config(padx=0, pady=20)

# Buttons

start_button = Button(text = "Start", command = click_start,highlightthickness = 0)
start_button.grid(column=0,row = 2)

reset_button = Button(text= "Reset", command = click_reset,highlightthickness = 0)
